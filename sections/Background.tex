...
\begin{figure}
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{lit_review/fig/dog.png}
    \caption{Example image of a dog correctly classified as a dog.}
  \end{subfigure}
  \begin{subfigure}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{lit_review/fig/dog_noisy.png}
    \caption{Example noisy image of a dog that could be incorrectly classified as a cat.}
  \end{subfigure}
